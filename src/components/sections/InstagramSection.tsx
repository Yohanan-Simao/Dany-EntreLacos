      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3 rounded-full bg-white px-6 py-3 text-primary-dark font-semibold transition-[gap,background-color] group-hover:bg-white/90 group-hover:gap-4 shrink-0">
